...
interface Hotel {
 ...
 nameID: number;
 name: string;
 stateZoneID: number | null;
 stateZoneName: string | null;
 cityZoneID: number | null;
 cityZoneName: string | null;
 hotelOwnershipTypeID: number | null;
 hotelOwnershipTypeName: string | null;
 hotelOperatorTypeID: number | null;
 ...
 hotelThemeID: number | null;
 hotelThemeName: string | null;
